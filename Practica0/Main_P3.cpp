...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate( model, 0.5f, glm::vec3( 1.0f, 3.0f, 1.0f ) ); // use to compare orthographic and perspective projection
		...
		view = glm::translate(view, glm::vec3(0.0f, 0.0f, -10.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(1.0f, 2.14f, -1.0f)); // use to compare orthographic and perspective projection
		...
		view = glm::translate(view, glm::vec3(0.0f, 0.0f, -10.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(1.0f, -4.14f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		model = glm::translate(model, glm::vec3(-2.0f, 0.0f, 0.0f));
		//view = glm::translate( view, glm::vec3( screenWidth / 2+1, screenHeight / 2+1,0 ) ); // use with orthographic projection
...
//Se ha usado la proyección ortogonal
//Se ha usado la proyección en perspectiva
//Se ha descomentado la linea de traslación de la vista
//Se ha vuelto a usar la proyección ortogonal
//Ejercicio 1: Dos cubos, mirando a la izquierda y a la z
